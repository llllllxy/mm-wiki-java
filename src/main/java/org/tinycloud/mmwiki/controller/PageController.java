...
public class PageController extends ControllerSupport {
    ...
    @ResponseBody
    public JsonResponse<Void> modify(@RequestParam("document_id") String documentId,
    ...
    public ResponseEntity<ByteArrayResource> export(@RequestParam("document_id") String documentId,
                                                    @RequestParam(name = "output", required = false, defaultValue = "markdown") String output) throws Exception {
